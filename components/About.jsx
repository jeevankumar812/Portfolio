      ...
      <motion.div
        ...
        <motion.div
          ...
          {/* --- Updated About Me Text --- */}
            ...
            <a href="https://leetcode.com/YOUR_USERNAME" target="_blank" className="text-blue-500 hover:underline"> LeetCode</a> and 
            <a href="https://auth.geeksforgeeks.org/user/YOUR_USERNAME/practice" target="_blank" className="text-green-600 hover:underline"> GeeksforGeeks</a>.
          ...
          <motion.ul
            ...
            <motion.li
              ...
              <a href="https://github.com/YOUR_GITHUB" target="_blank"
                className='text-gray-800 dark:text-white font-semibold'>GitHub</a>
            </motion.li>
